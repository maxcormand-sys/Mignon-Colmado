...
export function Hero() {
  return (
    <section className="relative h-[200vh]">
      {/* Video background + logo - both sticky together */}
      <div className="sticky top-0 h-screen z-10">
        ...
        {/* Logo and tagline - centered, moves with video */}
      ...
      {/* Shop interior image - positioned at bottom, scrolls up naturally over sticky video */}
      <div className="relative h-screen z-20 -mt-screen" style={{ marginTop: '-100vh' }}>
        <Image
