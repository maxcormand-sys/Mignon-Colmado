...
export function Hero() {
  return (
    <section className="relative h-[200vh] overflow-clip">
      {/* Logo and tagline - sticky on top of everything */}
      <div className="sticky top-0 h-screen z-50 flex items-center justify-center pointer-events-none">
      ...
      {/* Shop interior image - scrolls up over video, under logo */}
      <div className="relative h-screen z-20 -mt-[100vh]">
        <Image
